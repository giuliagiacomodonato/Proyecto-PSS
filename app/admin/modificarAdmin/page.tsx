      ...
      <main className="flex-1 p-8">
        ...
        <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="mb-4 flex gap-2">
            <input type="text" placeholder="Buscar admin por DNI" value={dniBusqueda} onChange={(e)=>setDniBusqueda(e.target.value)} className="border px-3 py-2 rounded w-64 text-gray-900" />
